        ...
        <form action="{{route('user.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="flex gap-x-2">
                <div class="flex flex-col w-full">
                    ...
                    <input id="name" type="text" name="name" class="p-2 border-[2px] border-gray-500 rounded-md" required>
                ...
                <div class="flex flex-col w-full">
                    ...
                    <input class="p-2 border-[2px] border-gray-500 rounded-md" type="text" name="email" id="nama" placeholder="example@gmail.com" autocomplete="off" required>
                ...
                <div class="flex flex-col w-full">
                    ...
                    <input class="p-2 border-[2px] border-gray-500 rounded-md" type="number" name="no_telp" id="no_telp" placeholder="08821234123" autocomplete="off" required>
            ...
            <div class=" flex gap-x-2">
                <div class="flex flex-col w-full">
                    ...
                    <input class="p-2 border-[2px] border-gray-500 rounded-md" type="password" name="password" id="password"  placeholder=""  autocomplete="off" required>
                ...
                <div class="flex flex-col w-full">
                    ...
                    <input class="p-2 border-[2px] border-gray-500 rounded-md" type="password" name="password_confirmation" id="password_confirmation" autocomplete="off" required>
